...
const COPY = {
  zh: {
    ...
    catalogOrder: count => `${count} 件商品 · 商品顺序`,
    sort: '排序',
    sortFeatured: '默认顺序',
    sortLow: '价格由低到高',
    sortHigh: '价格由高到低',
    ...
    notFound: '商品不存在',
    notFoundHint: '这件商品可能已经从当前商品列表中移除。',
    backCatalog: '返回商品',
    selectVariant: '选择规格',
    ...
    savedNote: '这里的心愿单只保存在当前浏览器，不会提交订单。购买与实时库存请以商品页面为准。',
    productDetails: '商品详情',
    detailsOriginal: '以下商品说明保留日文原文。',
    savedList: 'WISHLIST',
    sharedSaved: '朋友分享的心愿单',
    mySaved: '我的心愿单',
    ...
    browseCatalog: '去浏览商品　↗',
    savedDisclaimer: '心愿单只保存在当前浏览器。分享时会把商品与规格编码进链接；它不是订单，价格和库存可能随时间变化。',
    toastEmpty: '心愿单是空的，先挑选几件喜欢的商品吧。',
    toastCopied: '分享链接已复制。',
    toastCleared: '心愿单已清空。',
    toastSaved: '已保存到我的心愿单。',
    priceUnknown: '价格待确认',
  ...
  ja: {
    ...
    priceCurrency: '価格',
    addSaved: 'ウィッシュリストに追加',
    saved: 'ウィッシュリストに追加済み',
    detailUnavailable: 'SOLD OUT',
    savedNote: 'ウィッシュリストはこのブラウザにのみ保存され、注文は送信されません。購入・最新在庫は商品ページをご確認ください。',
    productDetails: '商品詳細',
    detailsOriginal: '商品説明は日本語原文のまま掲載しています。',
    savedList: 'WISHLIST',
    sharedSaved: '共有されたウィッシュリスト',
    mySaved: 'マイウィッシュリスト',
    savedCount: count => `${count} 件`,
    sharedSuffix: ' · 共有リンク',
    localSuffix: ' · このブラウザに保存',
    saveToMine: 'マイウィッシュリストに保存',
    shareSaved: 'ウィッシュリストを共有',
    clearSaved: 'すべて削除',
    remove: '削除',
    totalReference: '合計参考価格',
    emptySaved: 'ウィッシュリストは空です',
    sharedEmpty: '共有リストに表示できる商品がありません。',
    localEmpty: '気になる商品をウィッシュリストに追加してください。',
    browseCatalog: '商品を見る　↗',
    savedDisclaimer: 'ウィッシュリストはこのブラウザにのみ保存されます。共有リンクには商品と仕様が含まれます。注文ではなく、価格・在庫は変動する場合があります。',
    toastEmpty: 'ウィッシュリストは空です。まず商品を選んでください。',
    toastCopied: '共有リンクをコピーしました。',
    toastCleared: 'ウィッシュリストを削除しました。',
    toastSaved: 'マイウィッシュリストに保存しました。',
    priceUnknown: '価格確認中',
    footerItems: count => `2026 Autumn & Winter · ${count} items`,
  },
};
...
function renderDetailPage(product) {
  ...
  document.querySelector('#detailAdd')?.addEventListener('click', () => {
    ...
    showToast(added ? text('saved') : state.lang === 'ja' ? 'この仕様はすでにウィッシュリストに追加されています。' : '这个规格已经在心愿单里。');
    renderDetailPage(product);
    updateHeader();
  });
}
...
function updateStaticChrome() {
  ...
  document.title = 'WAN VOYAGE · 2026 Autumn & Winter';
